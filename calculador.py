...
st.title("📱 Calculador de Lucro Real / Presumido")

st.set_page_config(
    page_title="📱 Calculador",
    page_icon="🧮",   # ícone
    layout="wide"
)
...
with col2:
    icms_credito_perc = st.number_input("Crédito ICMS (%)", value=0.00000, step=0.00001)
    icms_debito_perc = st.number_input("Débito ICMS (%)", value=0.00000, step=0.00001)
